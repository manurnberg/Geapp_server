...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('rxjs'), require('@angular/cdk/keycodes'), require('rxjs/operators'), require('@angular/cdk/platform'), require('@angular/cdk/coercion'), require('@angular/cdk/observers'),require('@angular/core'),require('@angular/common'),require('@angular/cdk/platform'),require('@angular/cdk/observers')) :
	typeof define === 'function' && define.amd ? define('@angular/cdk/a11y', ['exports', '@angular/common', '@angular/core', 'rxjs', '@angular/cdk/keycodes', 'rxjs/operators', '@angular/cdk/platform', '@angular/cdk/coercion', '@angular/cdk/observers','@angular/core','@angular/common','@angular/cdk/platform','@angular/cdk/observers'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.cdk = global.ng.cdk || {}, global.ng.cdk.a11y = {}),global.ng.common,global.ng.core,global.rxjs,global.ng.cdk.keycodes,global.rxjs.operators,global.ng.cdk.platform,global.ng.cdk.coercion,global.ng.cdk.observers,global.ng.core,global.ng.common,global.ng.cdk/platform,global.ng.cdk/observers));
}(this, (function (exports,common,core,rxjs,keycodes,operators,platform,coercion,observers,ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3) { 'use strict';
...
AriaDescriber.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: AriaDescriber, factory: function AriaDescriber_Factory(t) { return new (t || AriaDescriber)(ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AriaDescriber, [{
        ...
        args: [{ providedIn: 'root' }]
            ...
            }] }]; }, { _document: [], describe: [], removeDescription: [], ngOnDestroy: [], _createMessageElement: [], _setMessageId: [], _deleteMessageElement: [], _createMessagesContainer: [], _deleteMessagesContainer: [], _removeCdkDescribedByReferenceIds: [], _addMessageReference: [], _removeMessageReference: [], _isElementDescribedByMessage: [], _canBeDescribed: [], _isElementNode: [] });
...
InteractivityChecker.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: InteractivityChecker, factory: function InteractivityChecker_Factory(t) { return new (t || InteractivityChecker)(ɵngcc0.ɵɵinject(platform.Platform)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(InteractivityChecker, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: platform.Platform }]; }, { _platform: [], isDisabled: [], isVisible: [], isTabbable: [], isFocusable: [] });
...
FocusTrapFactory.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: FocusTrapFactory, factory: function FocusTrapFactory_Factory(t) { return new (t || FocusTrapFactory)(ɵngcc0.ɵɵinject(InteractivityChecker), ɵngcc0.ɵɵinject(core.NgZone), ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FocusTrapFactory, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: InteractivityChecker }, { type: core.NgZone }, { type: undefined, decorators: [{
                type: core.Inject,
                args: [common.DOCUMENT]
            }] }]; }, { _checker: [], _ngZone: [], _document: [], create: [] });
...
CdkTrapFocus.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkTrapFocus, selectors: [["", "cdkTrapFocus", ""]], factory: function CdkTrapFocus_Factory(t) { return new (t || CdkTrapFocus)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(FocusTrapFactory), ɵngcc0.ɵɵdirectiveInject(common.DOCUMENT)); }, inputs: { enabled: ["cdkTrapFocus", "enabled"], autoCapture: ["cdkTrapFocusAutoCapture", "autoCapture"] }, exportAs: ["cdkTrapFocus"] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTrapFocus, [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: FocusTrapFactory }, { type: undefined, decorators: [{
                type: core.Inject,
                args: [common.DOCUMENT]
...
LiveAnnouncer.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: LiveAnnouncer, factory: function LiveAnnouncer_Factory(t) { return new (t || LiveAnnouncer)(ɵngcc0.ɵɵinject(LIVE_ANNOUNCER_ELEMENT_TOKEN, 8), ɵngcc0.ɵɵinject(core.NgZone), ɵngcc0.ɵɵinject(common.DOCUMENT), ɵngcc0.ɵɵinject(LIVE_ANNOUNCER_DEFAULT_OPTIONS, 8)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(LiveAnnouncer, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: undefined, decorators: [{
                type: core.Optional
            ...
            }] }]; }, { _ngZone: [], _defaultOptions: [], _document: [], _liveElement: [], announce: [], clear: [], ngOnDestroy: [], _createLiveElement: [] });
...
CdkAriaLive.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkAriaLive, selectors: [["", "cdkAriaLive", ""]], factory: function CdkAriaLive_Factory(t) { return new (t || CdkAriaLive)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(LiveAnnouncer), ɵngcc0.ɵɵdirectiveInject(observers.ContentObserver), ɵngcc0.ɵɵdirectiveInject(core.NgZone)); }, inputs: { politeness: ["cdkAriaLive", "politeness"] }, exportAs: ["cdkAriaLive"] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkAriaLive, [{
        type: core.Directive,
        args: [{
                selector: '[cdkAriaLive]',
                exportAs: 'cdkAriaLive'
            }]
    }], function () { return [{ type: core.ElementRef }, { type: LiveAnnouncer }, { type: observers.ContentObserver }, { type: core.NgZone }]; }, { _elementRef: [], _liveAnnouncer: [], _contentObserver: [], _ngZone: [], _politeness: [], politeness: [{
            type: core.Input,
            args: ['cdkAriaLive']
        }], politeness: [], ngOnDestroy: [] });
    return CdkAriaLive;
}());
/**
 * \@docs-private \@deprecated \@breaking-change 8.0.0
...
FocusMonitor.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: FocusMonitor, factory: function FocusMonitor_Factory(t) { return new (t || FocusMonitor)(ɵngcc0.ɵɵinject(core.NgZone), ɵngcc0.ɵɵinject(platform.Platform)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FocusMonitor, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: core.NgZone }, { type: platform.Platform }]; }, { _ngZone: [], _platform: [], _origin: [], _windowFocused: [], _elementInfo: [], _monitoredElementCount: [], _documentKeydownListener: [], _documentMousedownListener: [], _documentTouchstartListener: [], _windowFocusListener: [], monitor: [], stopMonitoring: [], focusVia: [], ngOnDestroy: [], _toggleClass: [], _setClasses: [], _setOriginForCurrentEventQueue: [], _wasCausedByTouch: [], _onFocus: [], _lastFocusOrigin: [], _onBlur: [], _emitOrigin: [], _incrementMonitoredElementCount: [], _decrementMonitoredElementCount: [] });
    return FocusMonitor;
}());
/**
...
CdkMonitorFocus.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkMonitorFocus, selectors: [["", "cdkMonitorElementFocus", ""], ["", "cdkMonitorSubtreeFocus", ""]], factory: function CdkMonitorFocus_Factory(t) { return new (t || CdkMonitorFocus)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(FocusMonitor)); }, outputs: { cdkFocusChange: "cdkFocusChange" } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkMonitorFocus, [{
        type: core.Directive,
        args: [{
                selector: '[cdkMonitorElementFocus], [cdkMonitorSubtreeFocus]'
            }]
    }], function () { return [{ type: core.ElementRef }, { type: FocusMonitor }]; }, { _elementRef: [], _focusMonitor: [], cdkFocusChange: [{
            type: core.Output
        }], _monitorSubscription: [], ngOnDestroy: [] });
...
A11yModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: A11yModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(A11yModule, { declarations: [CdkAriaLive,
        CdkTrapFocus,
        CdkMonitorFocus], imports: [ɵngcc1.CommonModule, ɵngcc2.PlatformModule, ɵngcc3.ObserversModule], exports: [CdkAriaLive,
        CdkTrapFocus,
        CdkMonitorFocus] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(A11yModule, [{
        type: core.NgModule,
        args: [{
...
A11yModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function A11yModule_Factory(t) { return new (t || A11yModule)(); }, imports: [[common.CommonModule, platform.PlatformModule, observers.ObserversModule]] });
    return A11yModule;
}());
