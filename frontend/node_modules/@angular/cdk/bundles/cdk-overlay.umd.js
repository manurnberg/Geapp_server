...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/coercion'), require('@angular/cdk/scrolling'), require('@angular/common'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/platform'), require('@angular/cdk/bidi'), require('@angular/cdk/portal'), require('@angular/cdk/keycodes'),require('@angular/core'),require('@angular/cdk/bidi'),require('@angular/cdk/portal'),require('@angular/cdk/scrolling')) :
	typeof define === 'function' && define.amd ? define('@angular/cdk/overlay', ['exports', '@angular/cdk/coercion', '@angular/cdk/scrolling', '@angular/common', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/cdk/platform', '@angular/cdk/bidi', '@angular/cdk/portal', '@angular/cdk/keycodes','@angular/core','@angular/cdk/bidi','@angular/cdk/portal','@angular/cdk/scrolling'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.cdk = global.ng.cdk || {}, global.ng.cdk.overlay = {}),global.ng.cdk.coercion,global.ng.cdk.scrolling,global.ng.common,global.ng.core,global.rxjs,global.rxjs.operators,global.ng.cdk.platform,global.ng.cdk.bidi,global.ng.cdk.portal,global.ng.cdk.keycodes,global.ng.core,global.ng.cdk/bidi,global.ng.cdk/portal,global.ng.cdk/scrolling));
}(this, (function (exports,coercion,scrolling,common,core,rxjs,operators,platform,bidi,portal,keycodes,ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3) { 'use strict';
...
ScrollStrategyOptions.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ScrollStrategyOptions, factory: function ScrollStrategyOptions_Factory(t) { return new (t || ScrollStrategyOptions)(ɵngcc0.ɵɵinject(scrolling.ScrollDispatcher), ɵngcc0.ɵɵinject(scrolling.ViewportRuler), ɵngcc0.ɵɵinject(core.NgZone), ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ScrollStrategyOptions, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: scrolling.ScrollDispatcher }, { type: scrolling.ViewportRuler }, { type: core.NgZone }, { type: undefined, decorators: [{
                type: core.Inject,
...
OverlayKeyboardDispatcher.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: OverlayKeyboardDispatcher, factory: function OverlayKeyboardDispatcher_Factory(t) { return new (t || OverlayKeyboardDispatcher)(ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: 'root' });
...
OverlayContainer.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: OverlayContainer, factory: function OverlayContainer_Factory(t) { return new (t || OverlayContainer)(ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: 'root' });
...
ConnectedPositionStrategy = /** @class */ (function () {
    function ConnectedPositionStrategy(originPos, overlayPos, connectedTo, viewportRuler, document, platform$$1, overlayContainer) {
        ...
        this._positionStrategy = new FlexibleConnectedPositionStrategy(connectedTo, viewportRuler, document, platform$$1, overlayContainer)
...
OverlayPositionBuilder.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: OverlayPositionBuilder, factory: function OverlayPositionBuilder_Factory(t) { return new (t || OverlayPositionBuilder)(ɵngcc0.ɵɵinject(scrolling.ViewportRuler), ɵngcc0.ɵɵinject(common.DOCUMENT), ɵngcc0.ɵɵinject(platform.Platform), ɵngcc0.ɵɵinject(OverlayContainer)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(OverlayPositionBuilder, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: scrolling.ViewportRuler }, { type: undefined, decorators: [{
                type: core.Inject,
                args: [common.DOCUMENT]
            }] }, { type: platform.Platform }, { type: OverlayContainer }]; }, { _viewportRuler: [], _document: [], _platform: [], _overlayContainer: [], global: [], connectedTo: [], flexibleConnectedTo: [] });
...
Overlay.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: Overlay, factory: function Overlay_Factory(t) { return new (t || Overlay)(ɵngcc0.ɵɵinject(ScrollStrategyOptions), ɵngcc0.ɵɵinject(OverlayContainer), ɵngcc0.ɵɵinject(core.ComponentFactoryResolver), ɵngcc0.ɵɵinject(OverlayPositionBuilder), ɵngcc0.ɵɵinject(OverlayKeyboardDispatcher), ɵngcc0.ɵɵinject(core.Injector), ɵngcc0.ɵɵinject(core.NgZone), ɵngcc0.ɵɵinject(common.DOCUMENT), ɵngcc0.ɵɵinject(bidi.Directionality), ɵngcc0.ɵɵinject(common.Location, 8)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Overlay, [{
        type: core.Injectable
    }], function () { return [{ type: ScrollStrategyOptions }, { type: OverlayContainer }, { type: core.ComponentFactoryResolver }, { type: OverlayPositionBuilder }, { type: OverlayKeyboardDispatcher }, { type: core.Injector }, { type: core.NgZone }, { type: undefined, decorators: [{
                type: core.Inject,
                args: [common.DOCUMENT]
            }] }, { type: bidi.Directionality }, { type: common.Location, decorators: [{
                type: core.Optional
...
CdkOverlayOrigin.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkOverlayOrigin, selectors: [["", "cdk-overlay-origin", ""], ["", "overlay-origin", ""], ["", "cdkOverlayOrigin", ""]], factory: function CdkOverlayOrigin_Factory(t) { return new (t || CdkOverlayOrigin)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef)); }, exportAs: ["cdkOverlayOrigin"] });
...
CdkConnectedOverlay.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkConnectedOverlay, selectors: [["", "cdk-connected-overlay", ""], ["", "connected-overlay", ""], ["", "cdkConnectedOverlay", ""]], factory: function CdkConnectedOverlay_Factory(t) { return new (t || CdkConnectedOverlay)(ɵngcc0.ɵɵdirectiveInject(Overlay), ɵngcc0.ɵɵdirectiveInject(core.TemplateRef), ɵngcc0.ɵɵdirectiveInject(core.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(CDK_CONNECTED_OVERLAY_SCROLL_STRATEGY), ɵngcc0.ɵɵdirectiveInject(bidi.Directionality, 8)); }, inputs: { viewportMargin: ["cdkConnectedOverlayViewportMargin", "viewportMargin"], open: ["cdkConnectedOverlayOpen", "open"], scrollStrategy: ["cdkConnectedOverlayScrollStrategy", "scrollStrategy"], offsetX: ["cdkConnectedOverlayOffsetX", "offsetX"], offsetY: ["cdkConnectedOverlayOffsetY", "offsetY"], hasBackdrop: ["cdkConnectedOverlayHasBackdrop", "hasBackdrop"], lockPosition: ["cdkConnectedOverlayLockPosition", "lockPosition"], flexibleDimensions: ["cdkConnectedOverlayFlexibleDimensions", "flexibleDimensions"], growAfterOpen: ["cdkConnectedOverlayGrowAfterOpen", "growAfterOpen"], push: ["cdkConnectedOverlayPush", "push"], positions: ["cdkConnectedOverlayPositions", "positions"], origin: ["cdkConnectedOverlayOrigin", "origin"], width: ["cdkConnectedOverlayWidth", "width"], height: ["cdkConnectedOverlayHeight", "height"], minWidth: ["cdkConnectedOverlayMinWidth", "minWidth"], minHeight: ["cdkConnectedOverlayMinHeight", "minHeight"], backdropClass: ["cdkConnectedOverlayBackdropClass", "backdropClass"], panelClass: ["cdkConnectedOverlayPanelClass", "panelClass"] }, outputs: { backdropClick: "backdropClick", positionChange: "positionChange", attach: "attach", detach: "detach", overlayKeydown: "overlayKeydown" }, exportAs: ["cdkConnectedOverlay"], features: [ɵngcc0.ɵɵNgOnChangesFeature()] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkConnectedOverlay, [{
    ...
    }], function () { return [{ type: Overlay }, { type: core.TemplateRef }, { type: core.ViewContainerRef }, { type: undefined, decorators: [{
                type: core.Inject,
...
OverlayModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: OverlayModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(OverlayModule, { declarations: [CdkConnectedOverlay,
        CdkOverlayOrigin], imports: [ɵngcc1.BidiModule, ɵngcc2.PortalModule, ɵngcc3.ScrollingModule], exports: [CdkConnectedOverlay,
        CdkOverlayOrigin, ɵngcc3.ScrollingModule] });
...
OverlayModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function OverlayModule_Factory(t) { return new (t || OverlayModule)(); }, providers: [
        Overlay,
        CDK_CONNECTED_OVERLAY_SCROLL_STRATEGY_PROVIDER,
    ], imports: [[bidi.BidiModule, portal.PortalModule, scrolling.ScrollingModule], ɵngcc3.ScrollingModule] });
...
FullscreenOverlayContainer.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: FullscreenOverlayContainer, factory: function FullscreenOverlayContainer_Factory(t) { return new (t || FullscreenOverlayContainer)(ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: 'root' });
